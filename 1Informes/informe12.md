FECHA: 15/05/2026
TURNO: 8 am - 12 am
MONITOR: Daniel Santiago Perez Madera

AVANCES:

* Se realizo el modulo para hacer los emorandos 
* se realizaron pruebas del envio de los memorandos 
* se agregaron las alertas en el menu de lideres y monitores para verificar los memorandos
* Se realizaron pruebas para el modulo 2 
...
* generacion automatica de memorando 
...
* verificar la estrucutra del memorando y el envio desde el correo 
